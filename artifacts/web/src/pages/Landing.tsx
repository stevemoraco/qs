...
const PROTOCOL_COMPARISON = [
  {
    ...
    signalLead: "Risk: your phone number can still be part of your identity trail.",
    imessageLead: "Risk: your Apple account, phone number, and devices are part of the map.",
  ...
  },
  {
    ...
    signalLead: "Risk: a powerful attacker can still study who started talking and when.",
    imessageLead: "Risk: Apple helps decide which devices get each message.",
  ...
  },
  {
    ...
    signalLead: "Risk: you still trust the app and device to show the real conversation.",
    imessageLead: "Risk: you cannot easily see or audit every protection step yourself.",
  ...
  },
  {
    ...
    signalLead: "Risk: even hidden messages can leave clues about your activity.",
    imessageLead: "Risk: Apple routing can show which account and devices were involved.",
  ...
  },
  {
    ...
    signalLead: "Risk: once a message is on screen, malware or a camera can copy it.",
    imessageLead: "Risk: previews, screenshots, and backups can expose what encryption protected.",
  ...
  },
  {
    ...
    signalLead: "Risk: disappearing later does not erase what someone already copied.",
    imessageLead: "Risk: deleting in one place may not delete every synced or backed-up copy.",
