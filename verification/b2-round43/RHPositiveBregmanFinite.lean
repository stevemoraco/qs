...
Exact-source import for independent replay from:
...
energy, drift energy, and Bregman residual. This file does not formalize primes,
Chebyshev functions, Stieltjes integration, infinite series, zeta zeros, or RH.
-/
