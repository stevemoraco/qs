...
/-!
# NS C482 finite scalar core

This file formalizes only the finite algebra behind the projected-annulus
budget, the geometric scaling ledger for finite endpoint towers, and the
three-mode stationary countermodel. It does not formalize vector fields,
Fourier analysis, invariant measures, Navier--Stokes, or a Clay theorem.
-/
...
#print axioms enstrophyPartial_succ
#print axioms palinstrophyPartial_succ
#print axioms enstrophyPartial_closed
#print axioms palinstrophyPartial_closed
#print axioms enstrophyPartial_lt
#print axioms palinstrophyPartial_lt
#print axioms constant_cubic_mass
#print axioms projected_midband_floor
#print axioms triad_coefficients_sum_zero
#print axioms triad_nonzero_equilibrium
#print axioms triad_linear_energy_balance
