...
/-!
# YM C483 finite compression-residual core

Finite scalar and two-dimensional quadratic-form firewalls only. This file does
not formalize OS Hilbert spaces, transfer operators, Wilson RG, continuum
limits, Yang--Mills, or a Clay theorem.
-/
...
theorem hiddenTransfer_above_observed
    {epsilon : ℝ} (heps : 0 < epsilon) (hhalf : epsilon < 1 / 2) :
    (1 / 2 : ℝ) < 1 - epsilon := by
  linarith
...
#print axioms primalFrame_quartic_scaling
#print axioms hiddenKernel_breaks_relative_bound
#print axioms hiddenTransfer_above_observed
